...
# def greet(fx):
#   def mfx(*argss, **kwargss):                 # *args  takes values as tuple and **kwargs  takes values as dictionary
#     print("Good Morning")
#     fx(*argss, **kwargss)
...
# @greetings
def hello():
  print("come on guy's let's say laudly Hello world")

# hello()
# greetings(hello())
#use @greeting before function start and use only function name as hello() or use below methon without mentioning @greetings
