...
print(a is b)     #exact location of object in memory, python store these two value on the same location because both are immutable and having same values
print(a == b)     # compare value of object
