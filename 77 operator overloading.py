...
#     def __add__(self, x):
#         return f"{self.i+x.i}i + {self.j+x.j}j + {self.k+x.k}k"    # resulting vector will be string
...
class vector:
    ...
    def __add__(self, x):
        return vector(self.i+x.i, self.j+x.j, self.k+x.k)    # resulting vector will be vector
