...
example, to import the math module, which contains a variety of mathematical functions, you would use 
...
generally not recommended as it can lead to confusion and make it harder to understand where specific functions and variables are coming from.
...
In summary, the import statement in Python allows you to access the functions and variables defined in a module from within 
your current script. You can import the entire module, specific functions or variables, or use the * wildcard to import everything.
...
# from math import sqrt, pi             #import only sqrt and pi
# result = math.sqrt(9)
# print(result)

# from math import *                # to import everthing from math even function or variable
# #importin everything is not recommended 
...
# import math as m               #change module name with different one 
...
from rajesh44 import welcome, rajesh
print(rajesh)
welcome()
